...
if (in_array($host, array('hawkaoc.net'))) {
    ...
    header('Location://www.' . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']);
    exit();
}
...
if (
    ...
    &&  strstr(DStr($_SERVER["HTTP_ACCEPT_ENCODING"]), "gzip")
) { //而且浏览器接受GZIP
...
// 一些模板
function MkHeader($title, $suffix = '帝国资源中心')
{ //_
?>
    <!DOCTYPE html>
    <html lang="cn">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/rc.css?t=(20200813.144053)">
    ...
    <body>
        <div id="header">
            <ul class="nav">
                ...
                <li><a class="btn-mini" href="http://www.hawkaoe.net" target="_BLANK">论坛首页</a></li>
...
<?php   }
    ...
    function GetE_TypeAbbr($e_type_name)
    { //_
