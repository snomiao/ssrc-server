...
function GetComeFrom(&$url)
{
    ...
    if (false !== stripos($url, '//amt.hawkaoe.net/')) return "帝国资源中心";
    if (false !== stripos($url, '//www.hawkaoc.net/')) return "旧翔鹰帝国论坛";
    if (false !== stripos($url, '//www.hawkaoe.net/')) return "翔鹰帝国论坛";
    if (false !== stripos($url, '//hawkaoe.net/')) return "翔鹰帝国论坛";
    if (false !== stripos($url, '//aoczone.net/')) return "AoCZone\nVoobly官方论坛";
    if (false !== stripos($url, '//aoe.heavengames.com/')) return "AoE Heaven\n帝国时代天堂";
    if (false !== stripos($url, '//aoe3.heavengames.com/')) return "AoE3 Heaven\n帝国时代3天堂";
    if (false !== stripos($url, '//aok.heavengames.com/')) return "AoK Heaven\n帝国时代2天堂";
    if (false !== stripos($url, '//aom.heavengames.com/')) return "AoM Heaven\n神话时代天堂";
    if (false !== stripos($url, '//diguobbs.com/')) return "帝国战网";
    if (false !== stripos($url, '//forum.gamer.com.tw/')) return "巴哈姆特";
    if (false !== stripos($url, '//tieba.baidu.com/')) return "百度贴吧";
    if (false !== stripos($url, '//userpatch.aiscripters.net/')) return "UserPatch\nUserpatch官网";
    if (false !== stripos($url, '//www.1mod.org/')) return "中华MOD网";
    if (false !== stripos($url, '//www.33hudong.com/')) return "33互动";
    if (false !== stripos($url, '//www.ageofempires.com/')) return "帝国时代官网";
    if (false !== stripos($url, '//www.ageofempires.com/forums/')) return "帝国官方论坛";
    if (false !== stripos($url, '//www.ensemblestudios.com/')) return "全效工作室";
    if (false !== stripos($url, '//www.forgottenempires.net/')) return "AoE2: FE\n被遗忘的帝国MOD官网";
    if (false !== stripos($url, '//www.voobly.com/')) return "Voobly\nVoobly 国际联机平台";
    return '查看来源';
}
////////////////////
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/rc.css?(20200813.144104)">
    <link rel="stylesheet" type="text/css" href="css/view.css">
    <!-- <script strstr="text/ src="http://cssrefresh.frebsite.nl/js/cssrefresh.js"></script> -->
</head>
...
<body>
    <div id="header">
        <ul class="nav">
            ...
            <li> <a class="btn-mini" href="//www.hawkaoe.net" target="_BLANK">论坛首页</a> </li>
        </ul>
    </div>
    <div id="content">
